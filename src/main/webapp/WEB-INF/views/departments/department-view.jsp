	...
	<div class="section">
		...
		<div class="main">
			<div class="container-fluid">
				...
				<div class="action">
					<b class="text-danger">${department.name}</b>
					<div class="action-btn">
						<button type="button" class="btn btn-outline-primary">
							<i class="bi bi-printer"></i>Print
						</button>
						<a
							href="${pageContext.request.contextPath}/departments/edit/${department.id}"><button
				...
				<div class="info">
					<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
						<li class="nav-item" role="presentation">
							<button class="nav-link active" id="asset-details-tab"
								...
								aria-selected="true">List Of Members</button>
						</li>
						<li class="nav-item" role="presentation">
					...
					<div class="tab-content" id="pills-tabContent">
						<div class="tab-pane show active" id="asset-details"
							role="tabpanel" aria-labelledby="asset-details-tab" tabindex="0">
							<div class="pill-details">
								<c:forEach items="${department.getUserList()}" var="user">
									<table class="table table-bordered border-light" >
										<tr class="table-light">
											<td>Name</td>
											<td>${user.name}</td>
